...
internal class FtlProcessorTest {
    ...
    fun processFileByClassWithParam() {
        val stringParam = "zxc"
        val processFile = ftlProcessor.processFile(FtlProcessorTest::class.java, "FtlProcessorImplTestWithParam.ftl", arrayOf(stringParam))
    ...
    fun processFileByClassWithParamObject_2() {
        ...
        val processFile = ftlProcessor.processFile(FtlProcessorTest::class.java, "FtlProcessorImplTestWithParamObject.ftl", arrayOf(stringParam))
